          ...
          <form id="email-auth-form">
            ${isSignup ? `
              <div class="form-group" style="margin-bottom:1rem;">
                ...
                <input type="text" id="auth-full-name" class="form-control" placeholder="Enter your full name or agency name" value="" required />
              </div>
              <div class="form-group" style="margin-bottom:1rem;">
            ...
            <div class="form-group" style="margin-bottom:1rem;">
              ...
              <input type="email" id="auth-email-input" class="form-control" placeholder="your-email@domain.com" value="" required />
            </div>
